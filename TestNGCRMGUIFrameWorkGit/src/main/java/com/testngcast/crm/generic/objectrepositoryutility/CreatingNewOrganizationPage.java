...
public class CreatingNewOrganizationPage {
	...
	public CreatingNewOrganizationPage(WebDriver driver) { // Local Variable
		...
		// don't need to worry
		// about initialization because we can call a constructor which will take care
		// of initialization
		// At the time of object creation, this constructor is being executed.
		// This constructor will take care of initialization of object,loading the
		// object
		// and also it will take care of execution of all @FindBy annotations and load
		// the element with the current address
	}
